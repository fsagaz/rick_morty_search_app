...
function CharacterSuggested(props) {
    ...
    let nameEscaped = name.replace(/\s+/g, '-').toLowerCase();
    return (
      <Link to={"/character/"+nameEscaped} state={props.character}> {/* we pass the entire character object as props to the itemDetail  */}
